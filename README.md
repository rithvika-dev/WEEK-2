...
You can run any of the standalone JavaScript files from `arrays-and-modules` and `modern-js-features` using Node.js:
```bash
node arrays-and-modules/simple-arrays/temperatures.js
```
